...
// Arrays are stored in contiguous memory locations meaning each element is placed next to the previous one
// Elements in array can be accessed using their index
// Advantages: Fast access, Cache efficiency, Simple structure
